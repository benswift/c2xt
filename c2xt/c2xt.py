...
def xtlang_lib_header(libname, author, comment):
...
;; These bindings were automatically generated by c2xt.py on {3}

;;; Code:
""".format(libname, author, comment, datetime.datetime.now(datetime.timezone.utc))
...
def process_nanovg():
    with open('tests/nanovg.xtm', 'w') as outfile:
        print(xtlang_lib_header('nanovg', 'Ben Swift', 'TODO'), file=outfile)
